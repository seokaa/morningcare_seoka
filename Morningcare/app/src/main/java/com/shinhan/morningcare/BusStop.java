...
public class BusStop extends NMapActivity
        implements NMapView.OnMapStateChangeListener {

    // API-KEY
    public static final String API_KEY = "x48cLNLPiclh6Jklarxn";  //<---맨위에서 발급받은 본인 ClientID 넣으세요.
    // 네이버 맵 객체
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 네이버 지도 객체 생성
        mMapView = new NMapView(BusStop.this);
